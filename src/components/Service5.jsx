...
import asset1 from "../assets/image5.png";
  ...
  return (
    <div className="relative overflow-hidden pt-[40px] pb-[40px]">
      <div className="flex flex-wrap items-center justify-between max-w-[1280px] w-[85%] mx-auto gap-[20px]">
        ...
        {/* Image Content */}
        <div className="w-full lg:w-[46%] relative border rounded-[20px] bg-white mx-auto px-[20px] sm:px-[30px] pt-[40px] sm:pt-[60px] pb-[10px]">
          <img
